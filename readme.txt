...
``` 
python main.py input1.txt Munich Berlin (For doing Uninformed search) 
```

or

```
python main.py input1.txt Munich Berlin h_kassel.txt (For doing Informed search)
...
```
python main.py input1.txt Bremen Kassel
...
and
```
python main.py input1.txt London Kassel
...
```
python main.py input1.txt Munich Kassel h_kassel.txt
